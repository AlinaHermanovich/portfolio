...
export const projects: Project[] = [
  {
    ...
    headline:
      "Сопровождаю Атриум с\u00A02019г: сайт, навигация, реклама внутри и снаружи.",
    category: "Площадка",
    year: "2026",
    blurb:
...
export const aboutIntro =
  "Забираю на себя всё\u00A0визуальное оформление. Создаю структуру и\u00A0дизайн, которые транслируют вашу надежность и\u00A0помогают бизнесу продавать.";
