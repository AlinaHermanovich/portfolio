...
export const projects: Project[] = [
  {
    ...
    headline:
      "Собрала сайт, где стройка, квартиры и партнёры не свалены в одну кучу.",
    category: "Производство",
    year: "студия",
    blurb:
      "На старте были буклет и старый знак. Нужно было развести три потока: заказчик работ, покупатель жилья, поставщик.",
  ...
  atrium: {
    ...
    sections: [
      ...
      },
      {
        ...
        captions: [
          "Тексты и некоторые изображения — шаблонные, для последующей замены на реальные.",
        ],
        images: [
          "/prometei-home-1.png",
          "/prometei-home-2.png",
      ...
      },
      {
        ...
        body: "Чаще такие сайты открывают с телефона. Номер и заявка должны быть под рукой, тексты короче, чем на большом экране. Иначе человек закроет страницу и наберёт другого подрядчика.",
