    ...
    sections: [
      ...
      },
      {
      ...
      },
       {
        ...
        body: "Оформила ленту и сторис в одном стиле со школой. Часть макетов собрала шаблонами, чтобы админимстратор мог обновлять расписания на день самостоятельно. Ведение ленты осталось за дизайнером.",
        captions: [
          "Сетка шаблонов",
          "Посты в ленте",
        ],
