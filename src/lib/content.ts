  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Один баннер — три формата: экран в зале и баннеры для таргета. Текст и композиция те же, чтобы графика читалась и со смартфона, и из конца зала.",
        captions: [
          "Адаптация под таргет: пост и сторис.",
          "Адаптация под сцену: заставка на главный экран.",
        ],
        images: [
