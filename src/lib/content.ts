  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        id: "offline",
        navLabel: "Офлайн",
        title: "Офлайн-мероприятия клуба",
        body: "Для первого ивента разработала единый ключевой визуал, который легко масштабируется на любые форматы: от афиш и баннеров для экранов до навигационных ролл-апов и бейджей участников.",
        captions: ["Адаптация графики под экраны и печать"],
        images: ["/vcc-offline.png"],
      },
      {
        id: "photos",
        navLabel: "Фото",
        title: "Живые фото с мероприятия",
        body: "Живые фото с мероприятия",
        captions: ["Кадры с площадки"],
        images: ["/vcc-photos.png"],
      },
    ],
  },
};
