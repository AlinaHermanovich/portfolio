  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Ролл-ап и бейджи по ролям: инвестор, партнёр, стартап, команда. В типографию писала сама — заказчик не готовит файл к печати. Это была первая печать под стиль клуба: смотрели, как ложится краска, цвет сняли на видео и зафиксировали.",
        captions: [
          "Ролл-ап. Первая печать под стиль.",
          "Бейджи по ролям.",
          "Печать ролл-апа.",
          "Печать бейджей.",
        ],
      ...
      },
      {
        ...
        body: "Собрала макет мероприятия и сделала из него три формата: экран в зале, пост и сторис для таргета. Текст и композиция одни, кадр разный — чтобы с телефона и со сцены читалось одно и то же.",
        captions: [
          "Пост и сторис.",
          "Экран в зале до начала.",
        ],
        images: [
