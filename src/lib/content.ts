  ...
  slides: [
    {
      ...
      body: "Упаковала республиканский бизнес-конкурс. Разработала весь визуал от логотипа до наградной продукции. Как спикер разбирала с участниками, как сделать презентацию понятной. Как ментор прошла с финалисткой весь путь до защиты: пересобрали логику проекта, слайды и речь для жюри.",
