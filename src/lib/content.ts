  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        id: "instagram",
        navLabel: "Instagram",
        title: "Социальные сети (Instagram)",
        body: "Собрала визуальную сетку для постов. Логика та же: дорогой темный фон, крупная типографика и зеленые маркеры. Лента выглядит как единый премиальный журнал, который легко считывается.",
        captions: [
        ...
        body: "Композицию собрали с первого макета: заголовок, три метки, дата. На ней проверяли тон и картинку. Утвердили тёмно-зелёный и росток — рост, а не декор. Потом тот же макет нарезали под сторис, пост и экран в зале.",
        captions: [
