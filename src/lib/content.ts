  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Каркас утвердили сразу, тестировали только цвет и графику. Выбрали зеленый фон и метафору роста (росток). Готовый визуал адаптировали под три формата: широкий экран, пост и сторис.",
        captions: [
