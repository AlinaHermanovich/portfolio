  ...
  slides: [
    {
      ...
      body: "Упаковала республиканский бизнес-конкурс: весь визуал от логотипа до наградной продукции. Как спикер разбирала с участниками их презентации. Как ментор прошла с финалисткой весь путь до защиты: логика проекта, слайды и речь для жюри.",
