...
export const concepts = {
  ...
  slides: [
    {
      title: "Акт",
      body: "Анимированная презентация. Смотрела, как слайд держит ритм без лишней графики.",
      image: "/vcc-preview.png",
    },
    {
      title: "Belemsa",
      body: "Макеты сайта производственной компании. Сотрудничество не состоялось — экраны остались как разбор ниши.",
      image: "/vcc-preview.png",
    },
    {
      title: "Porsche",
      body: "Учебная анимация: 3D-модель и движение кадра. Не коммерческий заказ.",
      image: "/vcc-preview.png",
    },
  ],
};
