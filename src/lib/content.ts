...
export const projects: Project[] = [
    ...
    title: "Сайт и презентация: структура, которая не теряет суть",
        headline:
      "Масштабный проект для\u00A0БНТУ: спроектировала архитектуру и\u00A0дизайн для вуза и\u00A0международных партнеров.",
...
export const aboutPointsBiz = [
  ...
  {
    title: "Дизайн, который продает",
    body: "Картинка ради картинки бизнесу не нужна. Собираю графику, с которой отделу продаж проще вести разговор, а клиент сразу видит масштаб и смысл предложения.",
  },
  {
    title: "Говорим на одном языке",
    body: "В бэкграунде — маркетинг крупной площадки. Понимаю, что такое многоуровневые согласования, дедлайны и работа с подрядчиками. Как живёт большая компания, объяснять не нужно.",
  },
  {
    title: "Работа в команде",
    body: "Дизайн редко существует в вакууме. Если для проекта понадобятся узкие специалисты (например, таргет или видео), я порекомендую контакты или легко сработаюсь с вашим подрядчиком.",
...
export const concepts = {
  ...
  slides: [
    ...
    {
      title: "Семейный центр «Море». Упаковка бренда и SMM",
      body: "Закрыла все визуальные задачи для запуска проекта с нуля. Разработала айдентику, логотип и полиграфию, первые месяцы вела ленту соцсетей сама.",
      image: "/edu-extra-more.png",
      youtube: "",
      href: "https://www.instagram.com/sea_familyclub",
      linkLabel: "Инстаграм центра",
    },
  ],
};
export const conceptsBiz = {
  title: "Концепты",
  lead: "",
  slides: [
    {
