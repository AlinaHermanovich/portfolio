  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Бизнес-задача требовала максимальной скорости — я реализовала проект за один день. Вместо того чтобы просто оформить сырой текст, я полностью переработала его. Я вычистила «воду» и превратила слайды в пошаговый алгоритм-инструкцию для выступающих. Дизайн сделала намеренно минималистичным, подкрепив смыслы легкими иконками-зарисовками.",
