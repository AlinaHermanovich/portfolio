  ...
  "4u": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Собрала визуальную систему для соцсетей. Логика единая: темный фон, крупная типографика и зеленые маркеры. Аккаунт выглядит как строгий, деловой журнал.",
        captions: [
