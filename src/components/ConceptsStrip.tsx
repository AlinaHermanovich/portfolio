  ...
  return (
    <section id="concepts" className="relative overflow-x-clip py-[220px]">
      <button
        type="button"
        onClick={prev}
        className="absolute top-1/2 left-0 z-10 h-[220px] w-[51px] -translate-y-1/2 overflow-hidden"
      ...
      >
        ...
        <img
          src={prevSlide.image}
          alt=""
          className="h-full w-[640px] max-w-none object-cover object-right"
        />
      </button>
      <button
        type="button"
        onClick={next}
        className="absolute top-1/2 right-0 z-10 h-[220px] w-[51px] -translate-y-1/2 overflow-hidden"
      ...
      >
        ...
        <img
          src={nextSlide.image}
          alt=""
          className="h-full w-[640px] max-w-none object-cover object-left"
        />
      </button>
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-10 flex items-center gap-3 lg:mt-0">
              <button
                ...
                onClick={prev}
                aria-label="Назад"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-black/10 text-black/45 hover:bg-black/16 hover:text-black/70"
              >
